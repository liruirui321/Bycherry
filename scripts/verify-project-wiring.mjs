...
expect(heroSource.includes('const readingHref = "/reading"') && heroSource.includes("读读笔记") && !heroSource.includes('href: "/reading"') && !heroSource.includes('href="/reading"') && !heroSource.includes('preloadRouteForHref("/reading")') && !heroSource.includes("hero-reading-library") && !heroSource.includes('"reading-library" as'), "Hero may include one compact reading CTA, but must not add a repeated reading-library entrance block.");
