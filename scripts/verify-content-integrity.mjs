...
function verifyLearnerFacingArticleCopy() {
  ...
  expect(articleLibrarySource.includes("article-library-action-line") && articleLibrarySource.includes("article-library-output-line") && articleLibrarySource.includes("检查：${article.firstCheck}"), "Reading library entries must expose first action, completion check, and learner output.");
