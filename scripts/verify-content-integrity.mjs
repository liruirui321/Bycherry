...
function verifyLearnerFacingArticleCopy() {
  ...
  expect(articleLibrarySource.includes("article-library-meta") && !articleLibrarySource.includes("article-library-action-line") && !articleLibrarySource.includes("article-library-output-line") && !articleLibrarySource.includes("article-library-actions"), "Reading library visible rows must stay as short index entries without repeated action/output blocks.");
