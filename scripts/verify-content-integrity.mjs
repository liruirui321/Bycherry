...
function verifyWorkCardActions() {
  ...
  expect(heroSource.includes("borderLeft: `0.45rem solid ${entry.border}`") && heroSource.includes("minHeight: 180") && !heroSource.includes("minHeight: 224") && !heroSource.includes("minHeight: 260"), "Homepage module entries must keep enough content density without returning to overly long sticky-note panels.");
