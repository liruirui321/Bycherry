...
function verifyWorkCardActions() {
  ...
  expect(heroSource.includes("hero-layout") && heroSource.includes("hero-featured-panel") && heroSource.includes("精选内容"), "Hero must use a first-screen brand panel plus featured content cards.");
  ...
  expect(heroSource.includes('className="hero-entry-grid"') && heroSource.includes('gridTemplateColumns: "repeat(2, minmax(0, 1fr))"'), "Homepage module entries must render as a two-column first-screen featured directory, not repeated sections.");
...
function verifyWorkJsonLdLearningOutcomes() {
  ...
  expect(heroSource.includes(".hero-entry-grid") && heroSource.includes("grid-template-columns: repeat(2, minmax(0, 1fr)) !important") && heroSource.includes("padding: 0.56rem !important") && heroSource.includes(".hero-entry-action") && heroSource.includes("display: none !important"), "Homepage hero mobile featured directory must remain short while fitting the visible viewport.");
