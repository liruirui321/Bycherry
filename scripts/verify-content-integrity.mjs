...
function verifyWorkCardActions() {
  ...
  expect(heroSource.includes('aria-label="使用方式"') && heroSource.includes("先选一个卡住的问题") && heroSource.includes("点卡片直接开始") && !heroSource.includes("hero-scope-strip") && !heroSource.includes("hero-scope-item"), "Homepage should use one compact usage strip instead of a repeated category scope row.");
