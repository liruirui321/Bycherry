...
function buildJsonLd(routes) {
  ...
  return {
    ...
    "@graph": [
      ...
      itemList("works", "By Cherry 可打开的作品", works),
      itemList("articles", "By Cherry 笔记与科研随笔", articles),
    ],
  };
}
...
function buildNoscript(routes) {
  ...
  return [
    ...
    "          <p>这是一个收录科学教育、AI 学习工具、项目制课程和创作工作流的个人网站。当前浏览器没有启用 JavaScript，下面是主要内容入口。</p>",
    "          <h2 style=\"font-size: 1.2rem; margin-top: 1.5rem;\">可打开的作品</h2>",
    "          <ul>",
    listItems(works),
    "          </ul>",
