...
export const essays = [
  ...
  },
  {
    ...
    starterTemplate: ["平台入口：https://scifusion.top", "使用场景：预习诊断 / 概念检查 / 复习巩固", "学习阶段：年级、学科、章节、当前基础", "测评目标：我需要证明自己能……", "知识点范围：本次只覆盖……", "题目设置：题型、难度、题量、预计完成时间", "生成要求：题干清楚，答案唯一，干扰项来自真实误解，解析说明原因", "人工审核：删掉跑题、歧义、超纲或解析空泛的题", "作答复盘：最高频错因是什么，下一步改学习卡还是补资料"],
