...
export const works = [
  ...
  },
  {
    ...
    outcome: "包含：6 个演化节点、证据说明、参考文献链接",
    status: "文献时间轴",
    href: "/works/plant-evolution-stories",
    tags: ["植物学", "科普", "插画"],
    audience: "初中生、科普读者、自然教育课程参与者",
    deliverables: ["链形植物绿藻与登陆前适应", "奥陶纪孢子作为最早陆地植物证据", "志留纪-泥盆纪早期陆地植物结构", "维管组织与植物长高", "晚泥盆世种子习性", "白垩纪被子植物多样化"],
    roadmap: ["先读故事，再看证据框", "用文献标签追踪每个结论来源", "区分化石证据和分子钟推测", "把每个节点整理成一张课堂时间轴卡片"],
