...
export const works = [
  {
    ...
    task: "只放 1 个 TF，再加入 RNA 聚合酶和核糖体，观察已转录片段、核糖体读取和多肽链增长如何变慢。",
    starter: "先把 TF 拖到启动子，再把 RNA 聚合酶拖到基因区，拖动时间滑块看 mRNA 如何跟随聚合酶延伸。",
    success: "能说清 DNA 信息如何转成 mRNA、核糖体如何读密码子，并用读数解释多肽链为什么变多或变少。",
  ...
  },
  {
    ...
    title: "科研学习工作台",
    desc: "把论文摘要、图注、实验设计或讨论段落拆成证据、推断、缺失信息和下一步核查。",
    task: "粘贴一段摘要或图注，运行本地预览，先得到任务判断、证据候选、风险标记和引用核查。",
    starter: "先载入读论文练习，运行本地预览，看系统如何把原文材料拆成证据、推断和不能直接下的结论。",
    success: "能把一段科研材料整理成可复核的研究记录，并说清哪些结论需要回查原文、图表或实验设计。",
    href: "/works/research-prompt-kit",
    updated: "2026-06-04",
    tags: ["AI", "科研阅读", "证据核查"],
    outputs: ["研究记录", "引用核查", "复核报告"],
    path: ["粘贴材料", "找证据", "核查结论"],
    action: "进入工作台",
  ...
  },
  {
    ...
    title: "概念解释生成器",
    desc: "输入任意概念或选择常用概念，生成自测问题、类比、机制步骤、可视化流程、迁移练习和即时小测。",
  ...
  },
  {
    ...
    title: "CRISPR 概念模拟器",
    desc: "在概念模型里调整 guide RNA、Cas 蛋白和修复结果，查看 PAM、匹配评分、风险核查和模拟报告。",
    task: "找出 PAM，切换 guide RNA，比较匹配评分如何影响概念模型里的切割判定和修复结果。",
    starter: "先选高匹配敲除场景，再切到错配比较，看判定为什么从推荐继续变成谨慎使用。",
    success: "能根据 PAM、guide 匹配评分和修复结果解释一次模拟编辑是否值得继续讨论，并写出风险理由。",
