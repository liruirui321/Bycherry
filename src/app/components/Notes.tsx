...
export const notes = [
  {
    ...
    readTime: "10",
    paragraphs: [
      "AI 最适合帮学习者处理低风险的材料整理：拆概念、列先修知识、生成对比表、把同一内容改写成不同难度版本。这些工作能节省时间，但不能自动证明你已经理解。",
  ...
  },
  {
    ...
    readTime: "11",
    paragraphs: [
      "读植物基因组研究，不是把论文摘要翻译成更简单的话。学习者需要一个能进入的问题，比如“为什么不同植物会有不同适应能力？”或者“同一种性状背后可能有哪些基因线索？”",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "一个好的项目作品不一定复杂，但必须能看出理解。例如调查报告、模型图、实验方案、科普短片或展板，都应该能回答：用了哪些资料，怎样组织证据，结论是否合理。",
    ...
    actionSteps: ["先确定最终作品和它要证明的学习目标", "把量规拆成问题、证据、解释、表达和修改五项", "每一步都留下过程证据", "用复盘记录说明作品哪里被修改得更可靠"],
    checklist: ["最终作品能证明学习目标", "量规在项目开始前已经给出", "过程证据和复盘修改能被追踪"],
    starterTemplate: ["驱动问题：我要解决……", "最终作品：我提交……", "评价量规：问题 / 证据 / 解释 / 表达 / 修改", "过程证据：草稿、资料卡、反馈、修订记录"],
