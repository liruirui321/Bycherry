...
export const notes = [
  {
    ...
    checklist: ["课程目标能用学生行为表述", "AI 输出经过学情和内容边界筛选", "材料修改有课堂反馈或小测证据"],
    starterTemplate: ["课程目标：学生能够……", "AI 可协助：整理资料 / 生成变体 / 提供检查清单", "人工必须判断：学情、误解风险、内容边界", "迭代证据：试讲观察 / 小测结果 / 学生反馈"],
    pitfalls: ["不要把 AI 生成的活动清单直接当课程设计", "不要用看起来丰富的材料掩盖学习目标不清", "不要让模型替你决定学生此刻能否理解"],
  },
  {
    id: 2,
    ...
    checklist: ["入口问题不是纯术语", "证据材料能被学生读懂", "结论和不确定性都被明确写出"],
    starterTemplate: ["进入问题：为什么……会出现差异？", "现象材料：学生能观察到……", "证据材料：图表/数据说明……", "解释限制：这些证据还不能证明……"],
    pitfalls: ["不要从测序技术名词开始讲", "不要把相关性材料讲成因果证明", "不要一次塞进完整论文流程"],
  },
  {
    id: 3,
